...
class ReactionEmojiBox extends StatefulWidget {
    static const routeName = '/reactionEmojiBox';

  ReactionEmojiBox();
  @override

   _ReactionEmojiBoxState createState() => _ReactionEmojiBoxState();
}

class _ReactionEmojiBoxState extends State<ReactionEmojiBox> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
     ...
     //-------------HOVERING ICONS MOVING  HIGH DISPLAY-----------------------------------------------
  ...
  String getImageIconBtn() {
    if (!isLongPress && isLiked) {
      return 'assets/home_smile.png';
    } else if (!isDragging) {
      switch (whichIconUserChoose) {
        case 1:
          return 'assets/home_smile.png';
        case 2:
          return 'assets/love2.png';
        case 3:
          return 'assets/haha2.png';
        case 4:
          return 'assets/wow2.png';
        case 5:
          return 'assets/sad2.png';
        case 6:
          return 'assets/angry2.png';
        default:
          return 'assets/home_smile.png';
      }
    } else {
